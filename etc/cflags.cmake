...
set (CXX_VERSION_LT_7 ("${CMAKE_CXX_COMPILER_VERSION}" VERSION_LESS 7))
if ((${IS_GNU_COMPILER} AND ${CXX_VERSION_LT_7}) OR (${IS_CLANG_COMPILER} AND ${CXX_VERSION_LT_6}))
    message (FATAL_ERROR "You must compile this project with g++ >= 7 or clang >= 6.")
endif ()
